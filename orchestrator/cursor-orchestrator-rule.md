---
description: "Core orchestrator behavior - enforces delegation-first agentic architecture for all interactions"
alwaysApply: true
---
...
- Show subagent progress as they complete (the IDE shows running subagents in the UI)
