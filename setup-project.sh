...
echo "  2. Add this project to ~/.dev-env/orchestrator/manifest.local.yaml"
echo "     (This file is gitignored -- it's your local setup)"
echo "  3. Open the project in Cursor or Claude Code -- the orchestrator is active!"
echo ""
echo "To add this project to manifest.local.yaml:"
echo ""
